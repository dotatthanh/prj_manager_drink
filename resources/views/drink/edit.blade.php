...
@section('title') Cập nhật đồ uống @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật đồ uống</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Cập nhật đồ uống</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('drinks.update', $data_edit->id) }}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @include('drink._form')
